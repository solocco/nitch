...
proc drawInfo*(asciiArt: bool) =
  ...
  # colored out
    stdout.styledWrite("\n", styleBright, "  ╭───────────╮\n")
    stdout.styledWrite("  │ ", color2, userIcon, color0, userCat, color0, userInfo, color0, "\n",)
    stdout.styledWrite("  │ ", color3, distroIcon, color0, distroCat, color0, distroInfo, color0, "\n")
    stdout.styledWrite("  │ ", color4, wmIcon, color0, wmCat, color0, wmInfo, color0, "\n")
    stdout.styledWrite("  │ ", color5, kernelIcon, color0, kernelCat, color0, kernelInfo, color0, "\n")
    stdout.styledWrite("  │ ", color6, ageIcon, color0, ageCat, color0, ageInfo, color0, "\n")
    stdout.styledWrite("  │ ", color2, uptimeIcon, color0, uptimeCat, color0, uptimeInfo, color0, "\n")
    stdout.styledWrite("  │ ", color6, shellIcon, color0, shellCat, color0, shellInfo, color0, "\n")
    stdout.styledWrite("  │ ", color1, pkgsIcon, color0, pkgsCat, color0, pkgsInfo, color0, "\n")
    stdout.styledWrite("  │ ", color2, ramIcon, color0, ramCat, color0, ramInfo, color0, "\n")
    stdout.styledWrite("  ├───────────┤\n")
